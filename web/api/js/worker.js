...
const CONFIG = {
  js: {
    mods: { 'actual-ecma': BASE + 'browser.js', 're2js': BASE + 're2js.js' },
    engines: [
  ...
  e262: {
    mods: { 'engine262': BASE + 'engine262.js' },
    engines: [{ id: 'engine262', name: 'engine262', flavor: 'ECMA spec', family: 'ECMAScript', version: '', url: 'https://github.com/engine262/engine262' }],
  },
  ocaml: {
...
function runMatch(d) {
  if (C.mods) {
    ...
    try { return mod ? mod.match(d.pattern, d.input) : { error: errs[d.engine] || 'unavailable' }; }
